...
class MC():
    ...
    def updateInhibitoryStates(self, localGCspikes, timestamp):    
        ...
        for i in list(self.inhibitoryWeights.keys()):
    ...
    def updateInhWeights(self):
        ...
        for i in list(self.inhReleaseTimes.keys()): 
            if i in list(self.plasticSynapses):
    ...
    def __init__(self, nMCs, nGCs, GCsPerNeurogenesis):
        ...
        for i in range(0, nMCs):
            ...
            for j in range(0, nNeurogenesis):
                GCidStart = int(j*GCsPerNeurogenesis+i*GCs_per_Neurogenesis_per_MC); 
                GCidStop = int(GCidStart + GCs_per_Neurogenesis_per_MC);
